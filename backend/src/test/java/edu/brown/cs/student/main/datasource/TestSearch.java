...
public class TestSearch {
    ...
    public void testDeSerializeThor() {
        try{
            MovieResponse response = this.searcher.deserializeMovieData("https://api.themoviedb.org" +
    ...
    public void testDeSerializeTerminator() {
        try{
            MovieResponse response = this.searcher.deserializeMovieData("https://api.themoviedb" +
